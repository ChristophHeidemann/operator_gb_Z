...
############################################################################                
    def simplify_cofactors(self):
        ...
        #self.__cofactors = [Cofactor(c,a,i,b,A) for (a,i,b),c in d.items() if c] TODO: cofactor
